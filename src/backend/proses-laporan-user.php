...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Untuk user, status default adalah "Antrian"
    $status = "Antrian";
    ...
    try {
        // Insert ke tabel laporan_mr - TANPA nomor_surat dan keperluan_surat
        $insert_stmt = $koneksi->prepare("INSERT INTO laporan_mr 
            (nomor_mr, tanggal_laporan, status, id_unit, id_user) 
            VALUES (?, ?, ?, ?, ?)");
...
// Hapus baris ini karena sudah tidak diperlukan
